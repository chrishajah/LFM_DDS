...
#
# Generated by export_simulation on Wed Oct 23 16:44:56 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './dds_001.sh' script.

./dds_001.sh -reset_run
...
./dds_001.sh -noclean_files

For more information on the script, please type './dds_001.sh -help'.
